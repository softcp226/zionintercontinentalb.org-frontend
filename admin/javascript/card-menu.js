...
const fetch_delete_card_application = async (DelBtn, card_application) => {
  ...
  try {
    const response = await fetch(
      "https://zionintercontinentalb-org-backend.glitch.me/api/admin/card_application/delete",
      {
        method: "POST",
...
(async () => {
  ...
  try {
    const response = await fetch(
      "https://zionintercontinentalb-org-backend.glitch.me/api/admin/card_application/fetch",
      {
        method: "POST",
        headers: { "content-type": "application/json" },
